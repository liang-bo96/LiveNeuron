...
def test_alias_import():
    ...
    from src.eelbrain_plotly_viz import BrainPlotly2DViz
...
def test_all_imports_together():
    ...
    from src.eelbrain_plotly_viz import (
        EelbrainPlotly2DViz,
        BrainPlotly2DViz,
    )
    from src.eelbrain_plotly_viz.sample_data import create_sample_brain_data
...
def test_direct_module_imports():
    ...
    try:
        from src.eelbrain_plotly_viz.viz_2d import EelbrainPlotly2DViz as DirectImport
        from src.eelbrain_plotly_viz.sample_data import (
